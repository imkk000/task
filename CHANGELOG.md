...
- The [`Executor`](https://pkg.go.dev/github.com/imkk000/task/v3#Executor) now
  uses the functional options pattern (#2085, #2147, #2148 by @pd93).
- The functional options for the
  [`taskfile.Reader`](https://pkg.go.dev/github.com/imkk000/task/v3/taskfile#Reader)
  and
  [`taskfile.Snippet`](https://pkg.go.dev/github.com/imkk000/task/v3/taskfile#Snippet)
  types no longer have the `Reader`/`Snippet` respective prefixes (#2148 by
  @pd93).
- [`taskfile.Reader`](https://pkg.go.dev/github.com/imkk000/task/v3/taskfile#Reader)
  no longer accepts a
  [`taskfile.Node`](https://pkg.go.dev/github.com/imkk000/task/v3/taskfile#Node).
  Instead nodes are passed directly into the
  [`Reader.Read`](https://pkg.go.dev/github.com/imkk000/task/v3/taskfile#Reader.Read)
  method (#2169 by @pd93).
- [`Reader.Read`](https://pkg.go.dev/github.com/imkk000/task/v3/taskfile#Reader.Read)
...
- [`task.InitTaskfile`](https://pkg.go.dev/github.com/imkk000/task/v3#InitTaskfile)
...
- [`TaskfileDecodeError.WithFileInfo`](https://pkg.go.dev/github.com/imkk000/task/v3/errors#TaskfileDecodeError.WithFileInfo)
...
- [`TaskfileSnippet`](https://pkg.go.dev/github.com/imkk000/task/v3/taskfile#Snippet)
  and related code moved from the `errors` package to the `taskfile` package
  (#2068 by @pd93).
- Renamed `TaskMissingRequiredVars` to
  [`TaskMissingRequiredVarsError`](https://pkg.go.dev/github.com/imkk000/task/v3/errors#TaskMissingRequiredVarsError)
  (#2052 by @vmaerten).
- Renamed `TaskNotAllowedVars` to
  [`TaskNotAllowedVarsError`](https://pkg.go.dev/github.com/imkk000/task/v3/errors#TaskNotAllowedVarsError)
  (#2052 by @vmaerten).
- The
  [`taskfile.Reader`](https://pkg.go.dev/github.com/imkk000/task/v3/taskfile#Reader)
...
- Removed our internal `logger.Logger` from the entire `taskfile` package (#2082
  ...
  - Users are now expected to pass a custom debug/prompt functions into
    ...
    [`WithDebugFunc`](https://pkg.go.dev/github.com/imkk000/task/v3/taskfile#WithDebugFunc)
    and
    [`WithPromptFunc`](https://pkg.go.dev/github.com/imkk000/task/v3/taskfile#WithPromptFunc)
    functional options.
